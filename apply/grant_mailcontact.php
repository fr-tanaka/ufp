...
$site_top = "https://ufp.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
//$to = "w.iwashina@frontier-ad.co.jp,n.yoshida@frontier-ad.co.jp,ufp@ut-ec.co.jp";
$to = "ufp_apply@ut-ec.co.jp";
//$to = "n.yoshida@frontier-ad.co.jp";
...
$subject = "UFPプログラム応募：Grant Track";
...
$re_subject = "UFPプログラム応募：Grant Track";
...
＜UFPプログラム応募：Grant Track＞

この度は、UFP Grant Trackにお申し込み頂き
誠にありがとうございます。

締め切り後、書類審査を行いますので暫くお待ち下さい。

尚、お急ぎの場合は当社までご遠慮なくお問い合わせ下さい。
...
〒113-8485 東京都文京区本郷7-3-1　東京大学南研究棟（アントレプレナーラボ）3F
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('電話番号','メールアドレス','メールアドレス（確認）');
...
<input class="asend" type="submit" value="　送信する　">
<input class="aback" type="button" value="前画面に戻る" onclick="history.back()"></p>
</form>
