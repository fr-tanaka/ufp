...
$subject = "Program application(English)：Grant Track";
...
$re_subject = "Program application(English)：Grant Track";
...
＜Program application：Grant Track＞

Thank you for your application to the UFP Grant Track.
...
<?php }else{ ?>
Thank you for your application to the UFP Grant Track.<br>
